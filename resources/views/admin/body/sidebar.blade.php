             ...
             <ul class="metismenu list-unstyled" id="side-menu">
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="true">
                         ...
                         <li>
                             <a href="{{ route('all.wholesaler') }}" class="waves-effect">
                                 <i class="ri-file-user-line"></i>
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="true">
                         ...
                         <li>
                             <a href="{{ route('add.due.payment') }}" class="waves-effect">
                                 <i class="ri-file-user-line"></i>
                                 <span>Add Due</span>
                             </a>
                         </li>
                ...
                <li>
                     ...
                     <ul class="sub-menu" aria-expanded="true">
                         ...
                         <li>
                             <a href="{{ route('all.return.product') }}">
                                 <i class="ri-mail-send-line"></i>
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="true">
                         <li>
                             ...
                             <ul class="sub-menu" aria-expanded="true">
                                 <li><a href="{{ route('all.bank') }}"><i class="ri-arrow-right-line"></i> All
                                         Bank</a></li>
                                 <li><a href="{{ route('add.bank') }}"><i class="ri-arrow-right-line"></i> Add
                                         Bank</a></li>
                             </ul>
                         </li>
                         <li>
                             ...
                             <ul class="sub-menu" aria-expanded="true">
                                 <li><a href="{{ route('all.expense') }}"><i class="ri-arrow-right-line"></i> All
                                         Expense</a></li>
                                 <li><a href="{{ route('add.expense') }}"><i class="ri-arrow-right-line"></i> Add
                                         Expense</a></li>
                             </ul>
                         </li>
                         ...
                         <li>
                             ...
                             <ul class="sub-menu" aria-expanded="false">
                                 <li><a href="{{ route('credit.customer') }}"><i class="ri-arrow-right-line"></i>Credit
                                         Customer</a>
                             </ul>
                         </li>
                         ...
                         <li>
                             ...
                             <ul class="sub-menu" aria-expanded="true">
                                 ...
                                 <li>
                                     <a href="{{ route('all.opening.supplier') }}"><i class="ri-arrow-right-line"></i>
                                         Supplier</a>
                                 </li>
                             </ul>
                         </li>
