<?php $__env->startSection('admin'); ?>
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo e(route('invoice.store')); ?>" method="POST" class="custom-validation" novalidate="" onsubmit="disableBtn(this.querySelector('button[type=submit]'))">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="md-3">
    ...
    <script>
        $(document).on("change", ".product", function() {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(route('get.product.stock', '')); ?>" + "/" + id,
                success: function(data) {
    ...
    <script>
        $(document).on("change", "#customer_type", function() {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(route('get.customer', '')); ?>" + "/" + id,
                success: function(data) {
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\angel-rose-inventory\resources\views/admin/invoice/invoice_add.blade.php ENDPATH**/ ?>