              ...
              <div class="navbar-brand-box">
                  ...
                  <a href="<?php echo e(route('admin.dashboard')); ?>" class="logo logo-light">
                      <span class="logo-sm">
                          ...
                          <h3 class="text-light mt-3">AR</h3>

                      </span>
                      <span class="logo-lg">
                          
                          <h3 class="text-light mt-3">AR Distribution</h3>
...
<?php /**PATH D:\xampp\htdocs\developer_mode\ar_distribution\resources\views/admin/body/header.blade.php ENDPATH**/ ?>