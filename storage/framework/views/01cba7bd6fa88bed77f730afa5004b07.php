         ...
         <div id="sidebar-menu">
             ...
             <ul class="metismenu list-unstyled" id="side-menu">
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="true">
                         <li><a href="<?php echo e(route('supplier.all')); ?>"><i class="ri-arrow-right-line"></i>All
                                 Supplier</a>
                         </li>
                     </ul>
                 </li>
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="true">
                         ...
                         <li>
                             <a href="<?php echo e(route('product.sales')); ?>" class="waves-effect">
                                 <i class="ri-mail-send-line"></i>
...
<?php /**PATH D:\xampp\htdocs\developer_mode\ar_distribution\resources\views/admin/body/sidebar.blade.php ENDPATH**/ ?>