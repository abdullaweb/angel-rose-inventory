                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    ...
                                    <input class="form-control" type="text" name="invoice_no"
                                        value="<?php echo e($invoice->invoice_no); ?>" id="purchase_no" readonly disabled>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="md-3">
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    ...
                                    <input type="text" class="form-control" name="supplier_id" id="supplier_id"
                                        value="<?php echo e($invoice->payment->customer->name); ?>" disabled>
                                </div>
                            </div>
                                            ...
                                            <tr class="tr">
                                                ...
                                                <td class="text-center">
                                                    <input type="text" class="form-control quantity"
                                                        ...
                                                        value="<?php echo e($item->selling_qty); ?>" disabled>
                                                </td>
                                                <td class="text-center">
                                                ...
                                                <td class="text-center">
                                                    <input type="text" class="form-control total_amount"
                                                        ...
                                                        value="<?php echo e($item->selling_price); ?>" disabled>
                                                </td>
                                            </tr>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u287342192/domains/nebulaitbd.com/public_html/inventory-for-angel-rose/project_files/resources/views/admin/invoice/invoice_view.blade.php ENDPATH**/ ?>