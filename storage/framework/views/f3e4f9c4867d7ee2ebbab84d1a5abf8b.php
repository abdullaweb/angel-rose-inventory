                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-center">
                                                <strong><?php echo e($supplierInfo->name); ?></strong>
                                            </td>
                                            <td class="text-center">
                                                <strong><?php echo e($supplierInfo->phone); ?></strong>
                                            </td>
                                            <td class="text-center">
                                                <strong><?php echo e($supplierInfo->address); ?></strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <form method="POST" class="custom-validation" action="<?php echo e(route('store.purchase.due')); ?>"
                                novalidate="">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="id" value="<?php echo e($purchaseInfo->id); ?>">
                                <input type="hidden" name="supplier_id" value="<?php echo e($supplierInfo->id); ?>">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3 mt-3">
                                            ...
                                            <input type="text" id="total_amount" name="total_amount" class="form-control"
                                                ...
                                                value="<?php echo e($purchaseInfo->total_amount); ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-3 mt-3">
                                            ...
                                            <input type="text" id="due_amount" name="due_amount" class="form-control"
                                                ...
                                                value="<?php echo e($purchaseInfo->due_amount); ?>" readonly>
                                        </div>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\angel_rose_inventory\resources\views/admin/purchase_page/purchase_due_payment.blade.php ENDPATH**/ ?>