        ...
        $(document).ready(function() {
            $('#customer_id').on('change', function() {
                ...
                if (customerId == '0') {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "<?php echo e(route('get.customer.due', '')); ?>" + "/" + customerId,
                        success: function(data) {
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\angelrose-software\resources\views/admin/invoice/invoice_add.blade.php ENDPATH**/ ?>