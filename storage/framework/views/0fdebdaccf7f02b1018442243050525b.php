    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo e(route('store.purchase')); ?>" method="POST" class="custom-validation" novalidate="" onsubmit="disableBtn(this.querySelector('button[type=submit]'))">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="md-3">
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\angel_rose_inventory\resources\views/admin/purchase_page/add_purchase.blade.php ENDPATH**/ ?>