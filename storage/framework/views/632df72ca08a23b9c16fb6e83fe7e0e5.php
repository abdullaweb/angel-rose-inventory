                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $invoiceDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $invoiceItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo e($invoiceItem->selling_qty); ?>
                                                ...
                                                <tr class="custom-border">
                                                    ...
                                                    <td colspan="2"></td>
                                                    <td>Paid Amount</td>
                                                    <td class="text-center"><?php echo e($invoice->payment->paid_amount); ?>/-
                                                    </td>
                                                </tr>
                                                <?php if($invoice->payment->due_amount != '0'): ?>
                                                    <tr class="custom-border">
                                                        ...
                                                        <td>Due Amount</td>
                                                        <td class="text-center">
                                                            <?php echo e($invoice->payment->due_amount); ?>/-
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\developer_mode\ar_distribution\resources\views/admin/pdf/invoice_pdf.blade.php ENDPATH**/ ?>