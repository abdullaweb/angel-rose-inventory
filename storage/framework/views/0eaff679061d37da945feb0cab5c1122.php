                                ...
                                <div class="row">
                                    <div class="col-6 mt-4">
                                        <address>
                                            <strong>To</strong>
                                            <br>
                                            <h5 class="mb-0"><?php echo e($purchase->supplier->name); ?></h5>
                                            <?php echo e($purchase->supplier->name); ?><br>
                                            <?php echo e($purchase->supplier->mobile_no); ?><br>
                                        </address>
                            ...
                            <div class="col-12">
                                <div>
                                    <div class="py-2 d-flex justify-content-between">
                                        <h3 class="font-size-16"><strong>Purchase No: <?php echo e($purchase->purchase_no); ?></strong>
                                        </h3>
                                        <h3 class="font-size-16"><strong>Date:
                                                <?php echo e(date('d-m-Y', strtotime($purchase->date))); ?></strong></h3>
                                    </div>
                                    <div class="">
                                        <table class="invoice_table text-center p-2" border="1" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                    $total_sum = '0';
                                                ?>
                                                <?php $__currentLoopData = $purchaseMeta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $purchaseItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($key + 1); ?></td>
                                                        <td>
                                                            <?php echo e($purchaseItem->product->name); ?>

                                                        </td>
                                                        <td>
                                                            <?php echo e($purchaseItem->quantity); ?>  <?php echo e($purchaseItem->product->unit->short_form); ?>

                                                        </td>
                                                        <td>
                                                            <?php echo e(number_format($purchaseItem->unit_price)); ?>/-
                                                        </td>
                                                        <td>
                                                            <?php echo e(number_format($purchaseItem->unit_price * $purchaseItem->quantity)); ?>/-
                                                        </td>
                                                    </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" class="in_word">
                                                        ...
                                                        ?>
                                                        <i><strong>In Word : </strong> <?php echo e($in_word); ?></i>
                                                    </td>
                                                    <td>Total</td>
                                                    <td class="text-center">
                                                        <?php echo e(number_format($purchase->total_amount)); ?>/-
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="row">
                            <div class="col-12 invoice_page">
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="text-muted"> Received By <strong><?php echo e($purchase->supplier->name); ?></strong>
                                    </p>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u287342192/domains/nebulaitbd.com/public_html/inventory-for-angel-rose/project_files/resources/views/admin/pdf/purchase_pdf.blade.php ENDPATH**/ ?>